...
beautiful.init("/home/padme/.config/awesome/mytheme/theme.lua")
...
-- {{{ Menu
-- Create a laucher widget and a main menut
--myawesomemenu = {
...
local function update_brightness(widget)
	local b = io.popen("xbacklight | cut -d. -f1")
	local status = b:read("*all")
	screen_b = string.format("%d", status)
	b:close()

	local brightness = "L: " .. string.format("%d", status) .. "%"
...
vicious.register( batwidget, vicious.widgets.bat, "B: $2%", 1, "BAT0" )
--temp = wibox.widget.textbox()
--temp:set_text(' ')
--voltext = wibox.widget.textbox()
--voltext:set_text(' ')
ligtext = wibox.widget.textbox()
ligtext:set_text(' ')
--CAPStext = wibox.widget.textbox()
--CAPStext:set_text(' ')
--clementine = wibox.widget.textbox()
--clementine:set_text(' ')
...
mytextclock = awful.widget.textclock("%A %d/%m/%Y - %R:%S", 1)
...
--	 right_layout:add(CAPStext)
--	 right_layout:add(space)
--	 right_layout:add(clementine)
--	 right_layout:add(space)
--	 right_layout:add(ramtext)
--	 right_layout:add(space)
--	 right_layout:add(ligtext)
--	 right_layout:add(space)
...
-- Screenshot automatici con tasto PrintScreen e scrot
	awful.key({ }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/Immagini/Screenshot/ 2>/dev/null'") awful.util.spawn("notify-send 'Screenshot captured'") end),
-- Lock con slock
...
-- Brightness
   awful.key({ }, "XF86MonBrightnessDown", function () awful.util.spawn("xbacklight -dec 5") awful.util.spawn("notify-send 'Luminosità down 5%'") end),
   awful.key({ }, "XF86MonBrightnessUp", function () awful.util.spawn("xbacklight -inc 5") awful.util.spawn("notify-send 'Luminosità up 5%'") end),
--	Spacefm
	awful.key({ modkey }, "e", function () awful.util.spawn("spacefm") end),
	awful.key({ modkey }, "F2", function () awful.util.spawn("/usr/local/bin/wifi_toggle.sh") end),
...
--	{ rule = { class = "cairo-dock" },     properties = { floating = true } },

    -- Set Firefox to always map on tags number 2 of screen 1.
--	{ rule = { class = "Firefox", instance = "Navigator"  }, properties = { tag = tags[1][2] } },
--	{ rule = { class = "telegram", instance = "telegram" }, properties = { tag = tags[1][1] } },
--	{ rule = { class = "Eclipse", instance = "Eclipse" }, properties = { tag = tags[1][3] } },
--	{ rule = { class = "Chromium", instance = "web.whatsapp.com" }, properties = { tag = tags[1][5] } },
}
-- }}}
...
--awful.util.spawn_with_shell("killall volume; volume")
--awful.util.spawn_with_shell("killal light; light")
--awful.util.spawn_with_shell("killall temp; temp")
--awful.util.spawn_with_shell("killall mem; mem")
--awful.util.spawn_with_shell("killall CAPS; CAPS")
awful.util.spawn_with_shell("killall total; total")
--awful.util.spawn_with_shell("mpd /home/padme/.mpd/mpd.conf")
...
-- Test different way for autorun
--os.execute("nm-applet &"),

-- Test single program (no "for" cicle) execution
...
--awful.util.spawn_with_shell("killall Telegram; telegram")
...
awful.util.spawn_with_shell("/usr/local/bin/deactivate_touchpad.zsh")
